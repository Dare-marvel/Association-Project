...
//        Dispenser11 dispenser = new Dispenser11();
        ...
        CakeParty cakeParty=new CakeParty();
        evaluator1.attendCakeParty();
        evaluator2.attendCakeParty();
        virus.serveCake();
        evaluator1.panicAtVirus();
        ranchu.sneakAndComment();
        System.out.println("______________The End___________________");
    }
}
