...
class Dispenser{
    ...
    public Dispenser() {
        System.out.println("Initializing Dispenser");
    }

    public void Froth(String flavour){
        System.out.println("Frothing the drink with "+flavour+" froth");
    }

    public void Froth(String flavour,int duration){
        System.out.println("Frothing the drink with "+flavour+" froth for "+duration+ "seconds");
    }

    public void Froth(int duration,String flavour){
        System.out.println("Frothing the drink with "+flavour+" froth for "+duration+ "seconds");
    }

    public void Froth(int duration, String flavour, String stuff){
        System.out.println("Frothing the drink with "+flavour+ " for " + duration + " seconds and sprinkling "+ stuff + " over it");
    }

    public void Froth(int duration){
        System.out.println("Frothing the drink for "+duration+" seconds");
    }
    ...
    public void prepareWeirdDrink(Drink d, Sugar s, Ice i){
        System.out.println("Preparing your drink");
        setTemp("hot");
        setTemp("cold");
        startflow("Coffee");
        ...
        startflow("Tea");
        startflow("Fanta");
        DropSugar(true,"extremely sweet");
        Froth("Chocolate",10);
        Mix();
        System.out.println("Weird Drink is ready to hynotise people");
